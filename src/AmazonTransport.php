...
class AmazonTransport extends AmazonInboundCore
{
    ...
    public function setReadyDate($d)
    {
        ...
        try {
            // Set minus_120 in genTime to false to avoid the date being set to an
            // earlier date than expected, as genTime removes 2m from the date to avoid
